...
public class v1_ListEx_Adpter extends BaseAdapter 
{
	//当前选中的项目索引
	...
	public v1_ListEx_Adpter(Context context,List<HashMap<String,Object>> list,int layoutid,String[] objField,int[] viewid)
	{
	    	...
	    	if (VType.equals("android.widget.Button"))
	    	{
	    		v.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						if (m_Callback!=null)m_Callback.OnClick("", obj);
					}});
	    	}
		}
