...
public class v1_project_layer_render_symbolexplorer_linesymbol_custom
{
	private v1_FormTemplate _Dialog = null; 
    public v1_project_layer_render_symbolexplorer_linesymbol_custom()
    {
    	_Dialog = new v1_FormTemplate(PubVar.m_DoEvent.m_Context);
    	_Dialog.SetOtherView(R.layout.v1_project_layer_render_symbolexplorer_linesymbol_custom);
    	_Dialog.ReSetSize(1f, 0.96f);
    	_Dialog.SetCaption(Tools.ToLocale("线符号"));

    	_Dialog.SetButtonInfo("1,"+R.drawable.v1_ok+","+Tools.ToLocale("确定")+"  ,确定", pCallback);
    	_Dialog.findViewById(R.id.btAdd).setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				pCallback.OnClick("增加", null);
			}});
	    	...
	    	if (Str.equals("确定"))
	    	{
	    		if (m_Callback!=null)
    			{
		    		if (m_SelectItem!=null)
		    		{
		    			...
		    			m_Callback.OnClick("符号库", (v1_SymbolObject)OBJ.get("SymbolObject"));
		    		}
    			}
	    		_Dialog.dismiss();
	    	}
