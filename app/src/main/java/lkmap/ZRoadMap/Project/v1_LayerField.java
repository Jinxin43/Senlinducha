...
public class v1_LayerField {
	...
	public void SetFieldTypeName(String fieldTypeName) {
		...
		if (fieldTypeName.equals("字符串"))
			this._FieldType = lkFieldType.enString;
		else if (fieldTypeName.equals("整型"))
			this._FieldType = lkFieldType.enInt;
		else if (fieldTypeName.equals("浮点型"))
			this._FieldType = lkFieldType.enFloat;
		else if (fieldTypeName.equals("双精度"))
			this._FieldType = lkFieldType.enFloat;
		else if (fieldTypeName.equals("布尔型"))
			this._FieldType = lkFieldType.enBoolean;
		else if (fieldTypeName.equals("日期型"))
	...
	// return PubVar.m_DoEvent.m_DictDataDB.getEnumList("自定义工程",
	// this._FieldEnumCode);
	//// return new
	// ArrayList<String>(PubVar.m_DoEvent.m_DictDataDB.getEnumList("自定义工程",
