...
public class v1_project_layer_bkmap_grid
{
	private v1_FormTemplate _Dialog = null; 
    public v1_project_layer_bkmap_grid()
    {
    	_Dialog = new v1_FormTemplate(PubVar.m_DoEvent.m_Context);
    	_Dialog.SetOtherView(R.layout.v1_project_layer_bkmap_grid);
...
//        ValidSubPathList.add("选择目录");
	...
	private void QueryBKMapFileOnSpecialPath(String SubPath)
	{
		...
		if(SubPath.equals("选择目录"))
		{
			...
			sd.SetCallback(new ICallback()
			{
				...
				public void OnClick(String Str, final Object ExtraStrT) 
				{
					...
					{
						List<HashMap<String,Object>> mapFileList = Tools.GetBKMapListFromFolder(importFile,lkMapFileType.enGrid);
						BindMapFileListToView(mapFileList);
					}
    	...
    	//读取已经有哪些底图文件
    	List<HashMap<String,Object>> mapFileList = Tools.GetBKMapList(SubPath,lkMapFileType.enGrid);
