...
public class v1_CGpsLine implements IOnTouchCommand, IOnPaint {
	...
	public void Edit() {
		...
		lkmap.Tools.Tools.ShowToast(PubVar.m_DoEvent.m_Context, Tools.ToLocale("无法编辑当前正在采集实体属性！"));
	}
	...
	public void Cancel() {
		if (this.m_DataCollectStatus == lkGpsReceiveDataStatus.enStop) {
			lkmap.Tools.Tools.ShowToast(PubVar.m_DoEvent.m_Context, Tools.ToLocale("当前没有正在采集的实体！"));
			return;
		}
	...
	public void UpdateGpsPosition(Coordinate newCoor) {
		...
		// 在此控制采集的时间间隔及最小距离，在系统变量
		// Tag_System_GPSMinTime,Tag_System_GPSMinDistance 里面
