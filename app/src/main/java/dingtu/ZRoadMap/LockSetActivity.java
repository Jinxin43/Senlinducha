...
public class LockSetActivity extends Activity implements
	...
	private static final int SETP_5 = 5; // 密码被清空
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lockPatternView = (LockPatternView)findViewById(R.id.iv_setlockpattern);
...
//		                Login.LOCK, MODE_PRIVATE);
//		        preferences
//		                .edit()
//		                .putString(Login.LOCK_KEY,
