		...
		httpHandler = new Handler() {
			public void handleMessage(Message msg) {
				...
				case 2:
					 ...
					 break;
				case 0:
//					 Toast.makeText(mContext, "无法连接到升级服务器",
//					 Toast.LENGTH_SHORT).show();
					 break;
				default:
					break;
	...
	private void showUpdateDialog()
	{
		...
		updateDialog.setTitle("系统更新");
		String messageDetails = "版本号："+ codeVersion+"  \n";
		if(detail != null)
		{
		...
		updateDialog.setPositiveButton("更新", new OnClickListener(){
		...
		try {
			...
			if (entity != null) {
				...
				if (null != mHashMap) {
					...
					{
						return 2;
//						Toast.makeText(PubVar.m_DoEvent.m_Context, "已经是最新版本", Toast.LENGTH_LONG).show();
					}
				}
			} else {
