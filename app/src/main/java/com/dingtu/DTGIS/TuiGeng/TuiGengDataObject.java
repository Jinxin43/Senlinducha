...
//GPS数据采集的基础点实体
public class TuiGengDataObject
{
	private boolean isUpdated = false;
	
	public TuiGengDataObject()
	{
	...
	public void ReadDataAndBindToView(String Where, String layerID,String layerType)
	{
        ...
        if (DR.Read()) 
        {
        	...
        	for(String FieldName : FieldNameList)
        	{
        		...
        		//最早版本的退耕，省市区县值里面是[代码]+名称
        		if(isUpdated)
        		{
        			if(FieldName.equals("F1")||FieldName.equals("F2")||FieldName.equals("F3")||FieldName.equals("F4"))
            		{
            			if(FValue.contains("]"))
            			{
...
//			{
//				this.SetDataBindItemValue(FieldName,FieldValue.substring(FieldValue.indexOf("]")+1));
//			}
//			else
//			{
